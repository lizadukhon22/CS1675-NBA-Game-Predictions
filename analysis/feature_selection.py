...
from evaluation.evaluation import EXPANDED_IMPORTANCE_FILE, evaluate_feature_set, load_eval_data
...
def load_combined_importance():
    if not Path(EXPANDED_IMPORTANCE_FILE).exists():
        raise FileNotFoundError(
            f"Missing {EXPANDED_IMPORTANCE_FILE}. Run python compare_models.py first."
        )
